...
<div class="row-fluid">
	<div class="span12 well">
			...
			<form action="" method="POST" class="form-horizontal" id="update_account">
				<fieldset>
					<legend>My Account</legend>

					<?php 
					if (isset($_GET['success']) === true && empty($_GET['success']) === true) {
						echo '<div class="alert alert-success">Your details have been updated successfully!</div><a href="/my_account.php" class="btn">Go Back</a>';
					} else {
					if (empty($_POST) === false && empty($errors) === true) {
							...
							header('Location: my_account.php?success');
							exit();
