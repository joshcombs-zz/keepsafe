<?php
$page_id = 'privacy';
$title   = 'KeepSafe Security Privacy Policy';
	...
	<div class="span12">
		<div class="well">
			...
			<p>This Privacy Policy governs the
				...
				information collected from users (each, a "User") of the <a
				href="http://www.keepsafesecurity.net">http://www.keepsafesecurity.net</a>
				website ("Site"). This privacy policy applies to the Site and all products and
				services offered by KeepSafe Security.
			</p>
			...
			<p>
				...
				(ISPs) utilized and other similar information.
			</p>
			...
			<p>
				KeepSafe Security may collect and use Users personal information
				...
				<ul>
					...
					<li><i>- To process payments</i><br>
						We
						may use the information Users provide about themselves when
					...
					<li><i>- To send periodic emails</i><br>
						We may use the email address to send User
			...
			<b>How we protect your information</b>
				<p>
					...
					storage and processing practices and
					...
					transaction information and data stored on
					our Site.
				</p>
			...
			<b>Sharing your personal information</b>
				<p>
					...
					others. We may share generic aggregated
					demographic information not linked to any
					personal identification information
					regarding visitors and users with our
					business partners, trusted affiliates and
					advertisers for the purposes outlined
					above.
				</p>

				<b>Third party websites</b>
				<p>
					Users may find advertising or other
					content on our Site that link to the sites
					and services of our partners, suppliers,
					advertisers, sponsors, licensors and other
					third parties. We do not control the
					content or links that appear on these
					sites and are not responsible for the
					practices employed by websites linked to
					or from our Site. In addition, these sites
					or services, including their content and
					links, may be constantly changing. These
					sites and services may have their own
					privacy policies and customer service
					policies. Browsing and interaction on any
					other website, including websites which
					have a link to our Site, is subject to
					that website's own terms and
					policies.
				</p>

			<b>Changes to this privacy policy</b>
				<p>
					KeepSafe Security has the discretion to
					update this privacy policy at any time.
					When we do, we will post a notification on
					the main page of our Site, revise the
					updated date at the bottom of this page
					and send you an email. We encourage Users
					to frequently check this page for any
					changes to stay informed about how we are
					helping to protect the personal
					information we collect. You acknowledge
					and agree that it is your responsibility
					to review this privacy policy periodically
					and become aware of modifications.
				</p>

			<b>Your acceptance of these terms</b>
				<p>By using this Site, you signify your
					acceptance of this policy. If you do not
					agree to this policy, please do not use
					our Site. Your continued use of the Site
					following the posting of changes to this
					policy will be deemed your acceptance of
					those changes.
				</p>
			...
			<b>Contacting us</b>
				<p>
					...
					<a href="http://www.keepsafesecurity.net">KeepSafe Security</a><br>
					<a href="http://www.keepsafesecurity.net">http://www.keepsafesecurity.net</a><br>
					KeepSafe Security<br>
					P.O. Box 7287<br>
