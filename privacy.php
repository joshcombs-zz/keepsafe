<?php
$page_id = 'privacy';
$title = "KeepSafe Security &middot; Privacy Policy";
?>
...
<?php include 'includes/overall/header.php'; ?>
    ...
    <div class="row">
    	<div class="span12">
<div class="well">
This Privacy Policy governs the manner in which KeepSafe Security collects, uses, maintains and discloses information collected from users (each, a "User") of the <a href="http://www.keepsafesecurity.net">http://www.keepsafesecurity.net</a> website ("Site"). This privacy policy applies to the Site and all products and services offered by KeepSafe Security.<br><br>
...
We may collect non-personal identification information about Users whenever they interact with our Site. Non-personal identification information may include the browser name, the type of computer and technical information about Users means of connection to our Site, such as the operating system and the Internet Service Providers (ISPs) utilized and other similar information.<br><br>
...
KeepSafe Security may collect and use Users personal information for the following purposes:<br>
<ul>
...
KeepSafe Security has the discretion to update this privacy policy at any time. When we do, we will post a notification on the main page of our Site, revise the updated date at the bottom of this page and send you an email. We encourage Users to frequently check this page for any changes to stay informed about how we are helping to protect the personal information we collect. You acknowledge and agree that it is your responsibility to review this privacy policy periodically and become aware of modifications.<br><br>
...
704.873.0803<br>
josh.combs@me.com<br>
<br>
This document was last updated on April 22, 2013<br><br>
</div>
</div>
