<?php
$page_id = 'home';
$title = "KeepSafe Security &middot; Home";
?>
    ...
    <div class="row">
      ...
      <div class="span4">
        <div class="well">
          ...
          <p>Call the National Company number and see how long it takes to get a real person. Try it at 9 p.m. at night. Call us anytime and a real person will answer. Here at KeepSafe, we are available at any time.</p>
          <p><a class="btn btn-primary" href="#">View details &raquo;</a></p>
        </div>
      </div><!-- /.span4 -->
    </div><!-- /.row -->
